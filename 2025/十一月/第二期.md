...
![](2025/十一月/images/温州医科大学第五十一届运动会.jpg)

11.13上午8:00，[温州医科大学第五十一届运动会](https://mp.weixin.qq.com/s/j-WGitLUlLOzG7LnQIa-iA)正式开幕。
...
6、[我国已完成第一阶段6G技术试验](https://www.peopleapp.com/column/30050750575-500007201371)，6G技术将服务对象从人、机、物拓展到智能体，服务空间从地面拓展到空天地一体化，实现“万智互联、数字孪生”的目标。

![](./images/6G1.jpg)

![](./images/6G4.jpg)

7、[“数据集市”交易活跃]()。迈向十五五，深入推进数字中国建设，深化数据资源开发利用，强化算力、算法、数据等高效供给。数据是驱动数字经济的关键要素。11.14，一场年度规模最大的数据产业供需大会在长三角举办。
...
1、[花豹、猎豹、美洲豹的区别](https://www.facebook.com/share/p/1A6tdtbkDn/)
...
4、数据库大作业进度（5%/100%），确定了大作业的基本方向（医院管理信息系统HIS——在demo基础上增添病房病床管理、优化药品管理机制），绘制好了初版的系统流程图
...
在信息系统（IS）开发过程中，前期的基本需求识别、业务对象定义、功能模块划分以及流程模型（BPD）和数据模型（ERD）的构建，是决定系统架构清晰度和可拓展性的关键阶段。系统设计质量60%取决于分析阶段。

“You cannot control what you cannot measure.”

——没有清晰的流程和模型，就无法控制系统质量。
